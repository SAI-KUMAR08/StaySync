...
// Rate limiting for financial mutations (payments/expenses). Higher ceiling than
// mutationLimiter so legitimate bulk admin work isn't blocked, while still
// throttling runaway/abusive requests.
